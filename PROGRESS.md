...
Personal academic tracker. Each course has its own `ROADMAP.md`.
Exam grades: **A** (90–100), **B** (75–89), **C** (60–74), **F** (<60 — retake required).
...
| Course | Phases | Status | Last Exam | Grade |
|--------|--------|--------|-----------|-------|
| [C](c/ROADMAP.md) | 9 / 10 | in progress | Phase 9 | A |
