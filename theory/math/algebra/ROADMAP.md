...
**Complete.** Final grade: **B** (university school exam, 2026-04-29)

## Reference materials

- Pre-calculus textbook (free PDF and web): [OpenStax Precalculus 2e](https://openstax.org/details/books/precalculus-2e)
- Calculus course (free, self-paced): [MIT OCW 18.01SC Single Variable Calculus](https://ocw.mit.edu/courses/18-01sc-single-variable-calculus-fall-2010/)

## See also

- [[Index]]
- [[../linear_algebra/Index|Linear Algebra]]
- [[../discrete/Index|Discrete Mathematics]]
